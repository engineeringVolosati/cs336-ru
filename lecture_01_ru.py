...
# EN: https://github.com/openai/tiktoken/blob/main/tiktoken_ext/openai_public.py#L23
...
class BPETokenizer(Tokenizer):
    ...
    def encode(self, string: str) -> list[int]:
        ...
        # Примечание: Это очень медленное осуществление
        # EN: Note: this is a very slow implementation
...
def get_gpt2_tokenizer():
    # Код: https://github.com/openai/tiktoken
    # EN: Code: https://github.com/openai/tiktoken
    # Вы можете использовать Cl100k_базу для гпт3,5-турбо или gpt4 символизатора
    # EN: You can use cl100k_base for the gpt3.5-turbo or gpt4 tokenizer
